...
BMOT, BPIP = MOT + ".ag.bak", PIP + ".ag.bak"
...
N_SAL = """                _sal = False
                if pos['ask'] > 0:
                    ...
                    if _TP and _rel >= _TP:
                        _sal = True                      # objetivo de beneficio
...
V = [
    ("g_ctrl", "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2", "0.195", "0.150", "0.031", "2024-08-15", "3.5", "0", "0", "0"),
    ("g_st30", "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2", "0.195", "0.150", "0.031", "2024-08-15", "3.5", "0.30", "0", "0"),
    ("g_st50", "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2", "0.195", "0.150", "0.031", "2024-08-15", "3.5", "0.50", "0", "0"),
    ("g_st70", "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2", "0.195", "0.150", "0.031", "2024-08-15", "3.5", "0.70", "0", "0"),
    ("g_tp50", "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2", "0.195", "0.150", "0.031", "2024-08-15", "3.5", "0", "0.50", "0"),
    ("g_tp100", "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2", "0.195", "0.150", "0.031", "2024-08-15", "3.5", "0", "1.00", "0"),
    ("g_st50tp100", "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2", "0.195", "0.150", "0.031", "2024-08-15", "3.5", "0.50", "1.00", "0"),
    ("g_tmax60", "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2", "0.195", "0.150", "0.031", "2024-08-15", "3.5", "0", "0", "60"),
]
...
try:
    ...
    procs = []
    for nombre, cap, frac, tmin, pausa, stopd, mt, anc, reac, score, uco, uiv, usk, desde, ksup, stopop, tp, tmax in V:
        env = dict(os.environ, RL="vodc", RL_CAP=cap, RL_SLIP="1.01",
                   ...
                   RL_UCO=uco, RL_UIV=uiv, RL_USK=usk, RL_DESDE=desde, RL_KSUP=ksup, RL_STOPOP=stopop, RL_TP=tp, RL_TMAX=tmax)
        ...
        print("lanzado %-12s stop=%s tp=%s tmax=%s" % (nombre, stopop, tp, tmax), flush=True)
