...
BMOT, BPIP = MOT + ".ex.bak", PIP + ".ex.bak"
...
V = [
    ("x_ref",     "800", "0.18", "140", "3", "0.15", "4", "0"),     # referencia (pausa3+stop15)
    ("x_f25",     "800", "0.25", "140", "3", "0.15", "4", "0"),     # (a) mas capital por trade
    ("x_f35",     "800", "0.35", "140", "3", "0.15", "4", "0"),
    ("x_f50",     "800", "0.50", "140", "3", "0.15", "4", "0"),
    ("x_f70",     "800", "0.70", "140", "3", "0.15", "4", "0"),
    ("x_f100",    "800", "1.00", "140", "3", "0.15", "4", "0"),     # todo el saldo
    ("x_t200",    "800", "0.25", "200", "3", "0.15", "4", "0"),     # (b) suelo mas alto
    ("x_t300",    "800", "0.35", "300", "3", "0.15", "4", "0"),
    ("x_mt6",     "800", "0.25", "140", "3", "0.15", "6", "0"),     # (c) mas operaciones/dia
    ("x_mt8",     "800", "0.25", "140", "3", "0.15", "8", "0"),
    ("x_mt99",    "800", "0.25", "140", "3", "0.15", "99", "0"),
    ("x_a2",      "800", "0.25", "140", "3", "0.15", "4", "2"),     # (d) ancho fijo
    ("x_a3",      "800", "0.25", "140", "3", "0.15", "4", "3"),
    ("x_a4",      "800", "0.25", "140", "3", "0.15", "4", "4"),
]
...
try:
    ...
    procs = []
    for nombre, cap, frac, tmin, pausa, stopd, mt, anc in V:
        ...
        print("lanzado %-9s cap=%s frac=%s tmin=%s mt=%s ancho=%s" % (nombre, cap, frac, tmin, mt, anc), flush=True)
