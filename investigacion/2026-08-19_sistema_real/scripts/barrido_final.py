...
BMOT, BPIP = MOT + ".fn.bak", PIP + ".fn.bak"
...
V = [
    ("f_base",    "600", "0.18", "140", "3", "0.15", "4", "0", "0", "0"),   # mejor config actual
    ("f_reac",    "600", "0.18", "140", "3", "0.15", "4", "0", "1", "0"),   # + reaccion honesta
    ("f_sc3",     "600", "0.18", "140", "3", "0.15", "4", "0", "0", "3"),   # + score opciones >=3
    ("f_sc2",     "600", "0.18", "140", "3", "0.15", "4", "0", "0", "2"),
    ("f_reac_sc3","600", "0.18", "140", "3", "0.15", "4", "0", "1", "3"),   # las dos
    ("f_reac_sc2","600", "0.18", "140", "3", "0.15", "4", "0", "1", "2"),
    ("f_800_b",   "800", "0.18", "185", "3", "0.15", "4", "0", "0", "0"),   # 800 con misma agresividad
    ("f_800_r",   "800", "0.18", "185", "3", "0.15", "4", "0", "1", "0"),
    ("f_800_rs3", "800", "0.18", "185", "3", "0.15", "4", "0", "1", "3"),
    ("f_p2_rs3",  "600", "0.18", "140", "2", "0.15", "4", "0", "1", "3"),   # racha maxima 2
    ("f_nopau_r", "600", "0.18", "140", "0", "0.15", "4", "0", "1", "0"),   # sin pausa (control)
    ("f_sc3_np",  "600", "0.18", "140", "0", "0.15", "4", "0", "0", "3"),   # score sin pausa
]
...
try:
    ...
    procs = []
    for nombre, cap, frac, tmin, pausa, stopd, mt, anc, reac, score in V:
        ...
        print("lanzado %-11s cap=%s tmin=%s pausa=%s reac=%s score=%s" % (nombre, cap, tmin, pausa, reac, score), flush=True)
