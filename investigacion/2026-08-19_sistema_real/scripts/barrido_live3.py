...
BMOT, BPIP = MOT + ".l3.bak", PIP + ".l3.bak"
INS = os.path.join(RAIZ, "sys2", "core", "instrumento.py")
BINS = INS + ".l3.bak"
AQUI = os.path.dirname(os.path.abspath(__file__))
HIJO = os.path.join(AQUI, "_dump_D3.py")
...
# DESCOMPOSICION DE LA BRECHA sobre los 3 dias capturados EN VIVO (cadena real 82 contratos/min
# con BID/ASK). Backtest tal cual: +572,67$. Realidad de la cuenta: -145,91$.
# Se quita una mentira por paso para ver cuanto vale cada una.
V = [
    ("L_0_actual", "600", "0.18", "140", "0", "0", "4", "0", "0", "0", "0.195", "0.150", "0.031", "", "0", "0", "0", "0", "0", "0.5", "", "", "mid", ""),
    ("L_1_honesto", "600", "0.18", "140", "0", "0", "4", "0", "0", "0", "0.195", "0.150", "0.031", "", "0", "0", "0", "0", "0", "0.5", "", "", "mid", "vod"),
    ("L_2_ask", "600", "0.18", "140", "0", "0", "4", "0", "0", "0", "0.195", "0.150", "0.031", "", "0", "0", "0", "0", "0", "0.5", "", "", "ask", "vod"),
    ("L_3_bid", "600", "0.18", "140", "0", "0", "4", "0", "0", "0", "0.195", "0.150", "0.031", "", "0", "0", "0", "0", "0", "0.5", "", "", "bid", "vod"),
]
...
try:
    ...
    procs = []
    for nombre, cap, frac, tmin, pausa, stopd, mt, anc, reac, score, uco, uiv, usk, desde, ksup, stopop, tp, tmax, tpa, mnymin, mnymax, mnydesde, precio, rl in V:
        env = dict(os.environ, RL=rl, RL_CAP=cap, RL_SLIP="1.01", RL_PRECIO=precio,
        ...
        print("lanzado %-12s RL=%-5s precio=%s" % (nombre, rl or "(motor tal cual)", precio), flush=True)
