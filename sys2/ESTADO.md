...
- Cold runs verdes: `cr_schema.py`, `cr_migracion.py`, `cr_supertrend.py`, `cr_entradas.py`, `cr_greeks_bs.py`, `cr_rebote.py`, `cr_motor.py`, `cr_validacion.py`, `cr_lookahead.py`, `cr_autocalibra.py`, `cr_salida.py`.
...
## ✅ MOTOR (backtest/motor.py = SIS70) — VERDE, reproduce el sistema validado
config.py + core/st1.py + core/reglas.py + core/instrumento.py + backtest/motor.py, todo verbatim
del agente. **cr_motor VERDE**: TOTAL **+72.375$ (+1.4%)** vs target +71.396; A1 +32.289 (+0.7%),
...
- (vacío — motor VERDE; siguiente: decisión piramidar + validacion.py §2.1 + lado vivo. Ver PENDIENTES.md)
