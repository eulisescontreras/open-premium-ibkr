...
- Cold runs verdes: `cr_schema.py`, `cr_migracion.py`, `cr_supertrend.py`, `cr_entradas.py`, `cr_greeks_bs.py`, `cr_rebote.py`, `cr_motor.py`, `cr_validacion.py`, `cr_lookahead.py`.
